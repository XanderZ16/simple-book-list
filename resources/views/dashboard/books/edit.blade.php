...
@section('content')
    ...
    <div class="h-screen flex justify-center items-center">
        <div class="w-[95%] max-w-screen-sm p-4 border-2 border-green-600 rounded-md shadow-md">
            <h1 class="font-semibold text-3xl text-center">Edit Buku</h1>
            ...
            <form action="/dashboard/books" method="post" class="flex flex-col items-center px-6 *:w-[95%]">
                ...
                <div class="relative flex flex-col justify-center mt-4 mb-6">
                    <input type="text" id="book-id" name="book_id" placeholder="" autofocus value="{{ old('book_id', $book->book_id) }}"
                ...
                <div class="relative flex flex-col justify-center mt-4 mb-6">
                    <input type="text" id="title" name="title" placeholder="" autofocus value="{{ old('title', $book->title) }}"
                        class="peer w-full px-3 pt-4 pb-3 rounded-md border border-gray-300">
                    <label for="title"
                ...
                <div class="relative flex flex-col justify-center mt-4 mb-6">
                    <input type="text" id="author" name="author" placeholder="" autofocus value="{{ old('author', $book->author) }}"
                        class="peer w-full px-3 pt-4 pb-3 rounded-md border border-gray-300">
                    <label for="author"
